...
package com.trdong19.trime.ime.window
 ...
 * Usually, resident windows should be initialized and added to the inputComponent in [com.trdong19.trime.ime.core.InputView].
 *
