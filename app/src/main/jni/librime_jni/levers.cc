...
Java_com_trdong19_trime_core_Rime_getAvailableRimeSchemaList(JNIEnv *env,
                                                           jclass /* thiz */) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_trdong19_trime_core_Rime_getSelectedRimeSchemaList(JNIEnv *env,
                                                          jclass /* thiz */) {
  SwitcherSettings switcher;
...
Java_com_trdong19_trime_core_Rime_selectRimeSchemas(JNIEnv *env,
                                                  jclass /* thiz */,
                                                  jobjectArray array) {
  SwitcherSettings switcher;
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_trdong19_trime_data_userdict_UserDictManager_getUserDictList(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_trdong19_trime_data_userdict_UserDictManager_backupUserDict(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_trdong19_trime_data_userdict_UserDictManager_restoreUserDict(
...
Java_com_trdong19_trime_data_userdict_UserDictManager_exportUserDict(
...
extern "C" JNIEXPORT jint JNICALL
Java_com_trdong19_trime_data_userdict_UserDictManager_importUserDict(
    JNIEnv *env, jclass clazz, jstring dict_name, jstring text_file) {
  SwitcherSettings switcher;
